        ...
        <div class="container pt-5">
          <div class="row gx-md-5">
            ...
            <div class=" col-12 mt-5 mt-md-0 col-md-6">
              <img class="w-100 pb-4" src="image/Logo.webp" alt="">
              <ul id="lien">
                        <li><a style="color: white; text-decoration:none;" href="../index.php">Accueil</a></li> <br>
                        <li><a style="color: white; text-decoration:none;" href="bhs.php">Business Healthcare school</a></li> <br>
                        <li><a style="color: white; text-decoration:none;" href="space.php">Energy Space</a></li> <br>
                        <li><a style="color: white; text-decoration:none;" href="blog.php">Blog</a></li>
                      </ul>
            </div>
          </div>
        </div>

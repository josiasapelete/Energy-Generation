...
<head>
  ...
  <!-- ================================ LIEN FONT POPPINS ========================= -->
  <link rel="shortcut icon" href="assets/image/lg.jpg" type="image/x-webp">
  ...
  <main>
    ...
    <section>
      ...
      <div class="container ">
        ...
        <div class="row my-5 my-md-4 align-items-center">
    ...
    <section>
      <div class="text-center " id="forma">
        <h1>La formation entreprenariat <br> solaire</h1>
      </div>
      <div class="img2"></div>
    </section> <br> <br>
    <section>
      ...
      <div>
        ...
        <div class="container">
          <p class="text-center p-3 fs-4">L’Energy Generation Incubator et le Co-working Space accueillent <br>
            ...
            Afin de soutenir <span class="col3">le développement d'un écosystème entrepreneurial international</span>, <br> l'incubateur accueillera des projets issus de l’Academy, mais aussi plusieurs projets de milieux <br> et de pays africains différents.
          </p>
        </div>
      </div>
    </section>
        ...
        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="assets/image/logos/log1.png.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="assets/image/logos/log2.png.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="assets/image/logos/log3.png.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
            ...
            <div class="carousel-item">
              <img src="assets/image/logos/log5.png.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="assets/image/logos/log6.png.jpg" class="d-block w-100" alt="...">
            </div>
          </div>

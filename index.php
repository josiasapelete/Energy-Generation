                ...
                <ul class="navbar-nav me-auto mb-2 offset-md-6 mb-lg-auto ">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                      <li><a class="dropdown-item" href="#">Business & Energy School</a></li>
                      <li><a class="dropdown-item" href="#">Business & HealthCare School</a></li>
                      <li><a class="dropdown-item" href="#">Business & Agri School</a></li>
                    </ul>
                  </li>
                  <li class="nav-item">
                   ...
                   <div class="col-12 col-md-6  ">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-8" >
                                <h1>VISION</h1>
                                <p class="text-lg-start p-3" >Permettre l'émergence d'une nouvelle génération africaine en mesure de relever le défi de la dignité humaine sur le continent africain et au-delà.</p>
                            </div> 
                        </div>
                  </div><br> <br> <br>
                    ...
                    <div class="col-12 col-md-6  align-items-center p-4 b ">
                          <div class="row">
                            ...
                            <div class="col-12 col-md-8 text-lg-start " >
                                <h1>MISSION</h1>
                                <p class="text-lg-start p-3" >Révolutionner l'accès à l'éducation, à l'accompagnement et au financement, en construisant un écosystème entrepreneurial solide où les jeunes africains peuvent prospérer et développer des entreprises hors du commun.</p>
                           </div>
                          </div>
                     </div>
             </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <p class="text-lg-start p-3" >
                                ...
                                développer leur prototype, ainsi que d’un accompagnement personnalisé pour structurer
            ...
            <div>
                ...
                <div class="container"  >
                    <p class="text-center p-3" >L’Energy Generation Incubator et le Co-working Space accueillent <br>
                        ...
                        des start-ups prometteuses dans le domaine de l'énergie, mais pas seulement. <br> <br>
                        Les services d'incubation incluent un coaching personnalisé, avec formation et mentorat, ainsi <br> qu’un soutien dans les activités quotidiennes et les défis rencontrés. <br> <br>
                        Afin de soutenir le développement d'un écosystème entrepreneurial international, <br> l'incubateur accueillera des projets issus de l’Academy, mais aussi plusieurs projets de milieux <br> et de pays africains différents.
                    </p>
                </div>
            </div>
        </section> 
